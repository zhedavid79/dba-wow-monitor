...
HANDLING: **BUILD_FOUNDATION_GPU_OPPORTUNISTIC**
...
**Bedst princip:** B650/B850 mATX, AM5, Wi-Fi, 4 DIMM, at least 2 M.2; buy the cheapest board that genuinely meets the feature set.

**Valg nu:** NY: [GIGABYTE B650M GAMING PLUS WIFI](https://www.proshop.dk/Bundkort/GIGABYTE-B650M-GAMING-PLUS-WIFI-Bundkort-AMD-B650-AMD-AM5-DDR5-RAM-Micro-ATX/3335794) — 1.170 kr.

**Købsregel:** Pay for socket life, connectivity and slots — not flagship VRMs/branding. X870/X870E only if a concrete required feature justifies it.

**Brugt/nyt:** Used only when identity/specs are explicit and price is materially below an equivalent new board.

| Alternativ | Pris | Kilde | Fordel | Ulempe |
|---|---:|---|---|---|
| [GIGABYTE B650M GAMING PLUS WIFI](https://www.proshop.dk/Bundkort/GIGABYTE-B650M-GAMING-PLUS-WIFI-Bundkort-AMD-B650-AMD-AM5-DDR5-RAM-Micro-ATX/3335794) | 1.170 kr. | NEW RETAIL | Current selected component in this complete working build. | Compare against the alternatives before buying. |

### Strømforsyning

**Bedst princip:** Quality 750–850W ATX 3.1, modular, native modern GPU power, compact enough for Z20.

**Valg nu:** NY: [MSI MAG A850GL PCIE5 II 850W ATX 3.1](https://www.proshop.dk/Stroemforsyning/MSI-MAG-A850GL-PCIE5-II-Stroemforsyning-850-Watt-120-mm-ATX-31-80-Plus-Gold-certified/3370565) — 629 kr.

**Købsregel:** A modest premium for real headroom is valuable because replacing the PSU later is wasted spend and rebuild work.

**Brugt/nyt:** New-first. Reliability, warranty and known cable set matter more than a small used saving.

| Alternativ | Pris | Kilde | Fordel | Ulempe |
|---|---:|---|---|---|
| [MSI MAG A850GL PCIE5 II 850W ATX 3.1](https://www.proshop.dk/Stroemforsyning/MSI-MAG-A850GL-PCIE5-II-Stroemforsyning-850-Watt-120-mm-ATX-31-80-Plus-Gold-certified/3370565) | 629 kr. | NEW RETAIL | Current selected component in this complete working build. | Compare against the alternatives before buying. |
| [Corsair RM750e (2025) 750W ATX 3.1](https://www.proshop.dk/Stroemforsyning/Corsair-RMe-Series-RM750e-2025-Stroemforsyning-750-Watt-120-mm-ATX-31-80-Plus-Gold-certified/3324407) | 799 kr. | NEW RETAIL | Compact 140 mm, ATX 3.1, modular, native modern GPU connector and strong warranty/brand support. | Currently costs more while offering less wattage than the MSI 850W deal. |
| [Corsair RM650e (2025) 650W ATX 3.1](https://www.proshop.dk/Stroemforsyning/Corsair-RMe-Series-RM650e-2025-Stroemforsyning-650-Watt-120-mm-ATX-31-80-Plus-Gold-certified/3324406) | 647 kr. | NEW RETAIL | Alternative already used in another complete verified self-build route. | Compatibility/value must be checked against the exact selected build. |

### Kabinet

**Bedst princip:** Jonsbo Z20 as the intended final enclosure.

**Valg nu:** NY: [Jonsbo Z20 Mesh White](https://www.proshop.dk/Kabinet/Jonsbo-Z20-Mesh-Kabinet-Minitower-Hvid/3407428) — 750 kr.

**Købsregel:** Buy once. A used exact Z20 is attractive if materially cheaper; do not buy a random temporary case unless total economics clearly win.

**Brugt/nyt:** Used is fine if complete and undamaged; exact model/fit must be known.

| Alternativ | Pris | Kilde | Fordel | Ulempe |
|---|---:|---|---|---|
| [Jonsbo Z20 Mesh White](https://www.proshop.dk/Kabinet/Jonsbo-Z20-Mesh-Kabinet-Minitower-Hvid/3407428) | 750 kr. | NEW RETAIL | Current selected component in this complete working build. | Compare against the alternatives before buying. |

### CPU-køler

**Bedst princip:** Strong AM5-compatible air cooler that fits <=163 mm; Arctic Freezer 36 class is the value reference.

**Valg nu:** NY: [Arctic Freezer 36 Black](https://www.proshop.dk/CPU-Koeler/Arctic-Freezer-36-Black-CPU-Luftkoeler/3238363) — 175 kr.

**Købsregel:** Cooling headroom is useful, but expensive AIOs add little to this WoW-focused build unless noise/aesthetics justify them.

**Brugt/nyt:** Used is attractive only with confirmed AM5 mounting hardware and healthy fans.

| Alternativ | Pris | Kilde | Fordel | Ulempe |
|---|---:|---|---|---|
| [Arctic Freezer 36 Black](https://www.proshop.dk/CPU-Koeler/Arctic-Freezer-36-Black-CPU-Luftkoeler/3238363) | 175 kr. | NEW RETAIL | Current selected component in this complete working build. | Compare against the alternatives before buying. |
...
**Brugt/nyt:** Used-first if memory-testable and clearly desktop DDR5.
...
**Brugt/nyt:** Used-first when genuine CPU identity and function are verified.
...
**Bedst princip:** Used sweet-spot GPU for 3840x1600/75 Hz; an ACCEPTABLE bridge GPU is valid when the price gap to SWEET SPOT is poor.

**Valg nu:** BRUGT: [rtx 2080 super](https://www.dba.dk/recommerce/forsale/item/24227603) — 1.600 kr.

**Købsregel:** Highest opportunity-cost part. Buy enough performance, then wait for exceptional used value rather than paying launch/new premiums.

**Brugt/nyt:** Strong used-first preference; function/stability must be verified and defective cards are hard-excluded.

| Alternativ | Pris | Kilde | Fordel | Ulempe |
|---|---:|---|---|---|
| [rtx 2080 super](https://www.dba.dk/recommerce/forsale/item/24227603) | 1.600 kr. | USED ASK | Current selected component in this complete working build. | Compare against the alternatives before buying. |
| [AMD Radeon RX 5700 XT 8GB GDDR6 Sapphire](https://www.dba.dk/recommerce/forsale/item/17048263) | 890 kr. | USED ASK | Alternative already used in another complete verified self-build route. | Compatibility/value must be checked against the exact selected build. |
| [Rx 5700 XT GPU, god stand](https://www.dba.dk/recommerce/forsale/item/23657851) | 1.090 kr. | USED ASK | Alternative already used in another complete verified self-build route. | Compatibility/value must be checked against the exact selected build. |
| [ASUS Dual GeForce RTX 2070 EVO V2 8GB GDDR6](https://www.dba.dk/recommerce/forsale/item/21763396) | 1.100 kr. | USED ASK | Alternative already used in another complete verified self-build route. | Compatibility/value must be checked against the exact selected build. |

### SSD/lager

**Bedst princip:** 500 GB NVMe value baseline; 1 TB when the incremental price is sensible; 250 GB only as an emergency bridge.

**Valg nu:** NY: [PNY CS1030 M.2 NVMe 500GB](https://www.proshop.dk/SSD/PNY-CS1030-M2-NVMe-500GB/3115954) — 703 kr.

**Købsregel:** Storage speed/capacity above adequacy produces little WoW FPS. It is easy to add later.

**Brugt/nyt:** New-first because modest saving rarely compensates for wear/SMART uncertainty.

| Alternativ | Pris | Kilde | Fordel | Ulempe |
|---|---:|---|---|---|
| [PNY CS1030 M.2 NVMe 500GB](https://www.proshop.dk/SSD/PNY-CS1030-M2-NVMe-500GB/3115954) | 703 kr. | NEW RETAIL | Current selected component in this complete working build. | Compare against the alternatives before buying. |
| [Kingston NV3 1TB M.2 NVMe](https://www.proshop.dk/SSD/Kingston-NV3-SSD-1TB-PCIe-40-M2-2280/3284682) | 1.212 kr. | NEW RETAIL | Comfortable capacity and no near-term storage upgrade. | Large premium with essentially no WoW FPS benefit. |
...
| 24 | [Ryzen 5 5600X + RTX 4060](https://www.dba.dk/recommerce/forsale/item/23356482) | **6.500 kr.** | ACCEPTABLE | C | UNKNOWN |
| 25 | [Core i7-10700 + RTX 3080](https://www.dba.dk/recommerce/forsale/item/21317324) | **7.000 kr.** | SWEET SPOT | C | UNKNOWN |
| 26 | [Ryzen 5 5600 + RTX 3070](https://www.dba.dk/recommerce/forsale/item/24093124) | **7.250 kr.** | SWEET SPOT | C | UNKNOWN |
